...
SELECT ROUND(AVG(BIZTOSITAS_KATEGORIAK.AR)) AS ATLAG_AR FROM BIZTOSITAS, BIZTOSITAS_KATEGORIAK
...
SELECT KATEGORIA, COUNT(BIZTOSITAS.KATEGORIAID) AS DARAB FROM BIZTOSITAS, BIZTOSITAS_KATEGORIAK
